...
const SignUpPage: React.FC = () => {
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      handleAlert("error", error); // Use the error message provided by rejectWithValue
    }
  };
...
//         }, 3000);
//       } else if (
//         result.payload?.status_code === 400 &&
//         result.payload?.message_code === "EMAIL_ALREADY_REGISTERED"
//       ) {
//         handleAlert(
//           "error",
//           `The email "${email}" is already registered. Please log in.`
//         );
//       } else {
