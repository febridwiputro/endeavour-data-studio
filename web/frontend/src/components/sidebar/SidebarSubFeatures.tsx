...
interface SubSubFeature {
  name: string;
  sub_features_2?: Point[];
}

interface SubFeature {
  name: string;
  sub_features_1?: SubSubFeature[];
}
          ...
          <div>
            ...
            {openSubMenus[menuName] === subFeature.name &&
              subFeature.sub_features_1 && (
                <ul className="mt-2 space-y-1 px-4">
                  {subFeature.sub_features_1.map((subSubFeature, subSubIndex) => (
                    <li key={`subSubFeature-${subSubIndex}`}>
                      <div>
                        <summary
                          onClick={() =>
                            handleSubSubMenuToggle(
                        ...
                        {openSubSubMenus[`${menuName}-${subFeature.name}`] ===
                          subSubFeature.name && (
                          <ul className="mt-2 space-y-1 px-4">
