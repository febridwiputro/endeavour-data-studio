...
const SidebarFilters: React.FC<SidebarFiltersProps> = ({
  ...
  return (
    <div className="mb-4 relative">
      ...
      <div
        className="p-4 flex items-center space-x-4 bg-white shadow-md rounded overflow-x-auto overflow-y-hidden"
        style={{
          whiteSpace: "nowrap",
          height: "auto", // Ensure height is restricted to avoid vertical scrolling
        }}
      >
        {/* Filter Button */}
        <button
        ...
        {/* Columns Button */}
        <button
          className="flex items-center bg-gray-200 hover:bg-gray-300 px-3 py-1 rounded text-sm font-medium focus:outline-none relative"
        ...
        {/* Predict Button */}
        <button
          className={`px-4 py-1 text-sm font-medium rounded focus:outline-none ${
            isPredictDisabled
        ...
        <div className="absolute top-20 left-0 bg-white border border-gray-300 shadow-md rounded z-50 p-4">
          ...
          <div className="flex items-center mb-2">
            ...
            <input
              type="checkbox"
              className="form-checkbox h-4 w-4 mr-2"
              checked={visibleColumns.annotated}
              onChange={() => toggleColumnVisibility("annotated")}
            />{" "}
            <label className="text-sm text-gray-700">Annotated</label>{" "}
          </div>{" "}
          <div className="flex items-center">
            ...
            <input
              type="checkbox"
              className="form-checkbox h-4 w-4 mr-2"
              checked={visibleColumns.predictBy}
              onChange={() => toggleColumnVisibility("predictBy")}
            />{" "}
            <label className="text-sm text-gray-700">Predict by</label>{" "}
          </div>{" "}
        </div>
      )}{" "}
    </div>
