  ...
  datasets: [
    {
      ...
      barThickness: 6, // Adjust this value to make the bar thinner
      borderRadius: 4,
    },
    {
      data: [100 - value],
      backgroundColor: `${color}33`, // Transparent background
      barThickness: 6, // Match thickness with solid portion
      borderRadius: 4,
    },
  ],
});
...
>
  <div
    className="bg-white rounded-lg shadow-lg p-6 w-[600px] max-h-[400px] overflow-y-auto"
  >
