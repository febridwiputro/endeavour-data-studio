  ...
  const handleSubSubMenuToggle = (
    ...
    setOpenSubSubMenus((prev) => ({
      ...
      [`${menuName}-${subFeatureName}`]:
        prev[`${menuName}-${subFeatureName}`] === subSubFeatureName ? null : subSubFeatureName,
    }));
  };
...
// import SidebarHeader from "./sidebar/SidebarHeader";
// import SidebarMenu from "./sidebar/SidebarMenu";
// import SidebarSubFeatures from "./sidebar/SidebarSubFeatures";
// import DarkModeToggle from "./sidebar/DarkModeToggle";
// import ProfileInfo from "./sidebar/ProfileInfo";
...
//           openMenu={openMenu}
//           handleMenuToggle={handleMenuToggle}
//           renderSubFeatures={renderSubFeatures}
//           isOpen={isOpen}
//           getMenuIcon={getMenuIcon}
//         />
//       </div>
