...
const NumericDataEditorPage = () => {
  ...
  const [selectedFeature, setSelectedFeature] =
    useState<FeatureKeys>("Basic Numeric Operations");
  const [isSidebarMinimized, setIsSidebarMinimized] = useState(false);

  useEffect(() => {
    if (router.pathname === "/numeric-data-editor") {
      setSelectedFeature("Basic Numeric Operations");
    }
  }, [router.pathname]);
  ...
  const breadcrumbItems = [
    ...
    {
      label: "Numeric Data Editor",
      href: "/numeric-data-editor",
  ...
  return (
    <Layout
      menuData={menu}
      onMenuClick={() => router.push("/numeric-data-editor")}
      selectedMenu="Numeric Data Editor"
