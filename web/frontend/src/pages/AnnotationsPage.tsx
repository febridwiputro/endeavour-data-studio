...
interface MenuItem {
  name: string; // Adjust this to match the structure of your menu items
}

const AnnotationsPage: React.FC = () => {
  const [showModal, setShowModal] = useState(false);

  // Explicitly define the type for menuData
  const menuData: MenuItem[] = []; // Replace MenuItem[] with the actual type if needed
