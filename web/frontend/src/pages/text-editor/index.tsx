...
const TextEditorPage = () => {
  ...
  const subFeatures: Record<FeatureKeys, string[]> = {
    ...
    "Text Statistics": ["Word, Character, Sentence Count", "Text Length Distribution"],
    "File Format Conversion": ["Markdown Conversion", "PDF to Text", "HTML to Text"],
  ...
  const [selectedFeature, setSelectedFeature] =
    useState<FeatureKeys>("Text Preprocessing");
  const [isSidebarMinimized, setIsSidebarMinimized] = useState(false);

  useEffect(() => {
    if (router.pathname === "/text-editor") {
      setSelectedFeature("Text Preprocessing");
    }
  }, [router.pathname]);
  ...
  return (
    <Layout
      menuData={menu}
      onMenuClick={() => router.push("/text-editor")}
      selectedMenu="Text Editor"
