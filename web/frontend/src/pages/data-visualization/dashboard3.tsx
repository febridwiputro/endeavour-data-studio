...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="max-h-screen bg-gray-100 p-0 flex">
      {/* Sidebar */}
      ...
      {selectedTemplate && (
        <aside className="w-1/3 bg-white rounded-lg shadow p-6 ml-6">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-2">
              <strong>Purpose:</strong> {selectedTemplate.purpose.join(", ")}
            </p>
          </div>
        </aside>
      )}
