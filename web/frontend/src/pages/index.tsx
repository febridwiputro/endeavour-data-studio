...
import ConcatenateVideo from '../components/ConcatenateVideo'; // Import ConcatenateVideo component
  ...
  <section style={{ color: 'var(--default-blue)' }} className="bg-white w-full">
    <div className="px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
      <div className="mx-auto max-w-full text-center">
        <h2 style={{ color: 'var(--default-blue)' }} className="text-3xl font-bold sm:text-4xl">Begin your process with DE</h2>
        ...
        <form className="w-[600px] mx-auto bg-white p-4 shadow-md rounded-lg" onSubmit={handleSubmit}>
          <div className="flex">
            ...
            <div className="relative flex-shrink-0">
              ...
              {isDropdownOpen && (
                <div className="absolute z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 mt-2">
                  <ul className="py-2 text-sm" style={{ color: 'var(--default-blue)' }}>
  ...
  <div className="min-h-screen bg-gray-100">
    ...
    <div className="flex">
      ...
      <div className="w-full p-6 bg-white shadow-md rounded-md ml-4">
        ...
        {!selectedMenu && renderDefaultContent(menu)} {/* Pass menuData to the renderDefaultContent */}
        ...
        {selectedMenu && selectedMenu !== 'Split by Number of Images' && selectedMenu !== 'Concatenate by Composition' && (
