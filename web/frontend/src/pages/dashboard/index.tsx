...
const DashboardPage: React.FC = () => {
  ...
  return (
    // <div className="min-h-screen w-full flex flex-col transition-colors bg-gray-100 dark:bg-gray-900 p-6">
    //   <div className="flex-grow bg-white dark:bg-gray-800 shadow-md rounded-md p-6">
        <div className="p-4">
          ...
          {!selectedMenu && (
            <>
              <h1 className="text-3xl font-bold text-center text-gray-900 mt-4 mb-8">Dashboard Menu</h1>
